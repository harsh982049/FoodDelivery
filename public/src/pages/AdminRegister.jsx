...
function Register()
{
    ...
    const onSubmit = async (values, actions) => {
        // console.log(values);
        // console.log(actions);
        const {username: adminName, email, password} = values;
        const {data} = await axios.post(adminRegisterRoute, {adminName, email, password});
        if(data.status)
        {
            ...
            <Container>
                <form onSubmit={handleSubmit} autoComplete="off">
                    ...
                    <div className='buttons'>
                        ...
                        <button className='login-btn' onClick={handleLogin}>Admin Login</button>
                    </div>
                </form>
            </Container>
            <ToastContainer/>
